<div id="jssor_1"
    ...
    <div data-u="slides"
        ...
        <div>
            <img data-u="image" src={{ asset('assets/img/031.jpg') }} />
            <img data-u="thumb" src={{ asset('assets/img/031-s190x90.jpg') }} />
        </div>
        <div>
            <img data-u="image" src={{ asset('assets/img/032.jpg') }} />
            <img data-u="thumb" src={{ asset('assets/img/032-s190x90.jpg') }} />
        </div>
        <div>
            <img data-u="image" src={{ asset('assets/img/033.jpg') }} />
            <img data-u="thumb" src={{ asset('assets/img/033-s190x90.jpg') }} />
        </div>
