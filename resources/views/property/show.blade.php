                    ...
                    <div class="card-body">
                        ...
                        <div class="user-detail">
                            <ul class="info-list">
                                ...
                                <li><span>{{ __('Rent') }} :- </span>{{ \Auth::user()->priceFormat($unit->rent) }}</li>
                                @if ($unit->rent_type == 'custom')
                                    <li>
                                        <span>{{ __('Start Date') }} :-
                                        </span>{{ \Auth::user()->dateFormat($unit->start_date) }}
                                    </li>
                                    <li>
                                        <span>{{ __('End Date') }} :-
                                        </span>{{ \Auth::user()->dateFormat($unit->end_date) }}
                                    </li>
                                    <li>
                                        <span>{{ __('Payment Due Date') }} :-
                                        </span>{{ \Auth::user()->dateFormat($unit->payment_due_date) }}
                                    </li>
                                @else
                                ...
                                <li>
                                    <span>{{ __('Deposit Amount') }} :-
                                    </span>{{ $unit->deposit_type == 'fixed' ? \Auth::user()->priceFormat($unit->deposit_amount) : $unit->deposit_amount . '%' }}
                                </li>
                                <li><span>{{ __('Late Fee Type') }} :- </span>{{ $unit->late_fee_type }}</li>
                                <li>
                                    <span>{{ __('Late Fee Amount') }} :-
                                    </span>{{ $unit->deposit_type == 'fixed' ? \Auth::user()->priceFormat($unit->late_fee_amount) : $unit->late_fee_amount . '%' }}
                                </li>
                                <li>
                                    <span>{{ __('Incident Receipt Amount') }} :-
                                    </span>{{ \Auth::user()->priceFormat($unit->incident_receipt_amount) }}
                                </li>
                            </ul>
