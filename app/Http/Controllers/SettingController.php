...
class SettingController extends Controller
{
    ...
    public function accountData(Request $request)
    {
        ...
        try {
            ...
            //dd($th);
            return redirect()->back()->with('error', 'Unable to update accout settings');
        }
    ...
    public function generalData(Request $request)
    {
        ...
        if(\Auth::user()->type == 'super admin')
        {
            ...
            {
                $logoName = 'logo.png';
                $path     = $request->file('logo')->storeAs('app/public/logo/', $logoName);
            ...
            {
                $favicon = 'favicon.png';
                $path    = $request->file('favicon')->storeAs('app/public/favicon/', $favicon);
        ...
        elseif(\Auth::user()->type == 'admin')
        {
            ...
            if($request->favicon)
            {
                ...
                $path     = $request->file('favicon')->storeAs('app/public/logo/', $logoName);
